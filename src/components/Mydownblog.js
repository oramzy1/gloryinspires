...
function Mydownblog({img, title, content, link}) {
    AOS.init()
  return (
    <div data-aos="flip-down" data-aos-duration='1000' className="col-12 col-md-3 bg-white p-1 mb-5 mx-md-3 mydownblog">
